 ...
 * @LastEditTime: 2020-10-03 17:20:16
...
namespace imp
{
    ...
    class tuple_traits<val,a,x...> :public tuple_traits<val,x...>
    {
    public:
        using Parent = tuple_traits<val,x...>;
        using type = a;
    ...
    constexpr typename tuple_traits<a,x...>::value::type& get( tuple <x...>& val )
    {
        using type = typename tuple_traits<a,x...>::value;
...
int main( void )
{
    ...
    std::cout << imp::get<char>( val ) << std::endl;
